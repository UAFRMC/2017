...
wall=1.4; // thickness of main walls (calibrate slicer to get just 2 passes)
outside_wall=2.0; // ground contact faces
...
module drive_ribs(fatten=0.0) {
	...
	offset(r=fatten)
	{
		...
		holy_ring(sprocket_radius,sprocket_radius-outside_wall); // outside
